            ...
            <div className="areaInfo">
                ...
                <div className="informacoes">
                    ...
                    <div className="container">
                        ...
                        <div className="inputGrid">
                            {/* <Fieldset label="Valor" type="text"  placeholder="Valor total do imóvel" handleValue={price} handleOnChange={(e) => setprice(e.target.value)} /> */}
                            ...
                            <Fieldset label="Taxa Desconta Antecipação" type="number" placeholder="Valor em %" handleValue={interestRate} handleOnChange={(e) => setinterestRate(e.target.value)} />
                        </div>
